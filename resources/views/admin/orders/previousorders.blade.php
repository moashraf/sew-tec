        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="page-title">  طلبات العملاء اسابقه | هذا القسم مختص بمراجعه طلبات العملاء بعد برور 7 ايام من تاريخ الطلب |</h4>
                    <ol class="breadcrumb">
                        <li>
                            <a href="#">العملاء</a>
                        </li>
                    ...
                    <div class="card-box table-responsive">
                        ...
                        <br>
                           <form action="#" id="action_form" method="post"  go="{{ url('ordersusers/deleteselected') }}">
                            ...
                            {{ csrf_field() }}
                        <table id="datatable-responsive" class="previousorders table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                <th>
...
<script type="text/javascript">
      $('.previousorders').dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ url('ordersusers/previousordersdatatable') }}",
        "columns": [
