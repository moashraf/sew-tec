                ...
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog " style="width:760px;">
                                <div class="modal-content">
                                 <form class="add_form" go="{{ url('/status/addstatus') }}"  >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" id="field-3" placeholder="اسم الحاله">
                                                </div>
                                            </div>
                        ...
                        <div class="button-list">
                            <button type="button" class="add btn btn-danger waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal">اضافة حاله</button>
                        ...
                        <br>
                        <br>
                           <form action="#" id="action_form" method="post"  go="{{ url('status/deleteselected') }}">

                            {{ csrf_field() }}
                        <table id="datatable-responsive" class="status table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                <th>
...
<script type="text/javascript">
      $('.status').dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ url('status/statusdatatable') }}",
        "columns": [
